...
\setup{% Remove the "%" on the next line when using UTF-8 character encoding
  ...
  title={*Thesis title*},
  author={*student name*},
  promotor={Prof.\,dr.\,ir.\ *promoterr name* \and Dr.\, ir. \ *promotor name*s},
  assessor={.....?},
...
\include{template/lit_review}
\include{template/chap-1}
\include{template/chap-2}
% ... and so on until
\include{template/chap-n}
\include{template/conclusion}

% If you have appendices:
\appendixpage*          % if wanted
\appendix
\include{template/app-A}
% ... and so on until
\include{template/app-n}
